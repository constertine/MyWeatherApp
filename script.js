...
let oldTab = userTab;
const API_key = "0f55b2112dfef424ee01c1c376d9ad92";
...
function switchTab(newTab){
    if(newTab != oldTab){
        ...
        if(!searchForm.classList.contains("active")){
            ...
            userInfoContainer.classList.remove("active");
            //ab main your weather tab me aaya hu , toh weather bhi display karna padega , so lets check local storage first
